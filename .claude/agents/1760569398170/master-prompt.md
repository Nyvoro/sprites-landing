...
1. **ALWAYS document your work in real-time** in `D:\projekte\Sprites\.claude\agents\1760569398170\documentation.md`
...
2. **ALWAYS ask questions** in `D:\projekte\Sprites\.claude\agents\1760569398170\questions.md` when:
...
```markdown
### [2025-10-15T23:03:18.171Z] - Started Task: [Task Name]
**Status:** In Progress
