...
1. **ALWAYS document your work in real-time** in `D:\projekte\Sprites\.claude\agents\1760569423370\documentation.md`
...
2. **ALWAYS ask questions** in `D:\projekte\Sprites\.claude\agents\1760569423370\questions.md` when:
...
```markdown
### [2025-10-15T23:03:43.371Z] - Started Task: [Task Name]
**Status:** In Progress
