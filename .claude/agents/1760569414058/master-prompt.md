...
1. **ALWAYS document your work in real-time** in `D:\projekte\Sprites\.claude\agents\1760569414058\documentation.md`
...
2. **ALWAYS ask questions** in `D:\projekte\Sprites\.claude\agents\1760569414058\questions.md` when:
...
```markdown
### [2025-10-15T23:03:34.059Z] - Started Task: [Task Name]
**Status:** In Progress
