...
1. **ALWAYS document your work in real-time** in `D:\projekte\Sprites\.claude\agents\1760569388371\documentation.md`
...
2. **ALWAYS ask questions** in `D:\projekte\Sprites\.claude\agents\1760569388371\questions.md` when:
...
```markdown
### [2025-10-15T23:03:08.371Z] - Started Task: [Task Name]
**Status:** In Progress
